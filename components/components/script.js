...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $("#icon_lua").click(function(){
        ...
        $('body, footer, header, .principal-box, .comentarios').css("background-color", "black"); 
        $('a, li, span, h1, h2, h3, h4, p, label').css("color", "white");
        $('#icon_sol').css("display", "block");

        $('.box-demonstracao, .add_produto, .box-img, .box-container, .flor-parecida, .info').css("background-color", "#0F270F");
    ...
    $("#icon_sol").click(function(){
        ...
        $('.add_produto, .card-form-vendedor').css("background-color", "#FFFAF7");
